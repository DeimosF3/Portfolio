    ...
    <main class="form-signin w-100 m-auto">
        <form action="views/auth/register.php" method="POST" class="mt-3">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" id="registerUsername" name="username" placeholder="Nombre de usuario" required />
            ...
            <button class="btn btn-outline-secondary w-100 py-2" type="submit">Regístrate</button>
        </form>
    </main>
</body>
